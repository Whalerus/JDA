...
{
    public GroupIconMessageEvent(JDA api, long responseNumber, GroupIconMessage message, Group group)
    {
        super(api, responseNumber, message, group);
    }

    @Override
    public GroupIconMessage getMessage()
    {
        return (GroupIconMessage) message;
    }
}
